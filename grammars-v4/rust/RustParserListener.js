...
export default class RustParserListener extends antlr4.tree.ParseTreeListener {
	...
	enterEnumerationVariantExpression_(ctx) {
	}

	// Exit a parse tree produced by RustParser#EnumerationVariantExpression_.
	exitEnumerationVariantExpression_(ctx) {
	}
